...
grViz("digraph {
  ...
  node [shape = rectangle, fontsize=40]        
  0 [label = 'START HERE!', color = 'aqua']
  ...
  node [shape = diamond, fontsize=40]
  ...
  1 -> 2
  H -> 1
  2 -> H [label = 'No', fontsize=40]
  2 -> 3 [label = 'Yes', fontsize=40]
  3 -> 4 [label = 'Yes', fontsize=40]
  3 -> 6 [label = 'No', fontsize=40]
  6 -> H [label = 'Yes', fontsize=40]
  6 -> H [label = 'No', fontsize=40]
  4 -> 5 [label = 'Yes', fontsize=40]
  4 -> H [label = 'No', fontsize=40]
  5 -> 7 [label = 'No', fontsize=40]
  7 -> 8 [label = 'No', fontsize=40]
  8 -> H [label = 'No', fontsize=40]
  5 -> 9 [label = 'Normal', fontsize=40]
  7 -> 9 [label = 'Normal', fontsize=40]
  8 -> 9 [label = 'Normal', fontsize=40]
  9 -> 10 [label = 'No', fontsize=40]
  10 -> H [label = 'No', fontsize=40]
  9 -> 11 [label = 'Yes', fontsize=40]
  11 -> 12 [label = 'Yes', fontsize=40]
  12 -> 13 [label = 'Yes', fontsize=40]
  11 -> 14 [label = 'No', fontsize=40]
  13 -> 14
  12 -> 14 [label = 'No', fontsize=40]
  14 -> 15
  15 -> 16
  16 -> 17
  17 -> 18
...
<span style="color:blue;"> *snippet fsr_assumptions_linearity* </span>
