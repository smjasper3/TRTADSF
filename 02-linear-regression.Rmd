...
grViz("digraph {
  ...
  0 [label = 'START HERE!', color = cornflowerblue, style=filled, URL='#select-alpha-level']
  1 [label = 'Build a linear model with all variables', URL='create-linear-model-of-all-variables']
  ...
  significant?', URL='#global-f-test']
  3 [label = 'Test Assumptions: 
  Linearity of the mean', URL='#linearity']
  6 [label = 'Residuals Polynomial?
  Use Higher Order']
  4 [label = 'Test Assumptions: 
  Independent Random Errors', URL='#independent-random-errors']
  5 [label = 'Test Assumptions:
  Normality', URL='#random-errors-normally-distributed']
  7 [label = 'Box Cox 
  Transform']
  8 [label = 'Transform 
  X-Values']
  9 [label = 'Test Assumptions: 
  Equal Variance', URL='#random-error-constant-variance']
  11 [label = 'Multiple 
  X-Vars?']
  12 [label = 'Any VIF 
  > 10?']
  ...
  1 -> 2 [style=bold]
  H -> 1 [style=bold]
  2 -> H [label = 'No', fontsize=40, color=dashed]
