...
grViz("digraph {
  ...
  0 [label = 'START HERE!', color = cornflowerblue, style=filled, URL='#select-alpha-level', fontcolor='blue']
  ...
  Equal Variance', URL='#random-error-constant-variance', fontcolor='blue']
  11 [label = 'Multiple 
  X-Vars?']
  12 [label = 'Any VIF 
  > 10?']
