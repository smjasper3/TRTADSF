...
## Select Alpha Level
<span style="color:blue;"> *snippet fsr_alpha *</span> [Back to Flowchart](#linear-regression){style="float:right"}
...
```{r fsr_alpha_codeblock, eval=FALSE}
...
[Back to Flowchart](#linear-regression){style="float:right"}
...
<span style="color:blue;"> *snippet fsr_globalF* </span> [Back to Flowchart](#linear-regression){style="float:right"}
...
```{r fsr_globalF_codeblock, eval=FALSE}
...
<span style="color:blue;"> *snippet fsr_assumptions_linearity* </span> [Back to Flowchart](#linear-regression){style="float:right"}

Check if they are linear (yes, keep moving)
(No) If they look polynomial/ quadratic/ etc. reconsider higher order terms

```{r fsr_assumptions_linearity_codeblock, eval=FALSE}
...
<span style="color:blue;"> *snippet fsr_assumptions_independence *</span> [Back to Flowchart](#linear-regression){style="float:right"}
...
```{r fsr_assumptions_independence_codeblock, eval=FALSE}
...
<span style="color:blue;"> *snippet fsr_assumptions_normdist *</span> [Back to Flowchart](#linear-regression){style="float:right"}
...
```{r fsr_assumptions_normdist_codeblock, eval=FALSE}
...
<span style="color:blue;"> *snippet fsr_assumptions_constvar *</span> [Back to Flowchart](#linear-regression){style="float:right"}
...
```{r fsr_assumptions_constvar_codeblock, eval=FALSE}
#Check to see if the below plot has a constant spread over the range of predicted values
library(ggplot2)
lm.model=lm(targetvar~.,data=dataset)
ggplot(lm.model,aes(x=fitted(lm.model),y=resid(lm.model))) +
...
<span style="color:blue;"> *snippet fsr_assumptions_multicol *</span> [Back to Flowchart](#linear-regression){style="float:right"}
...
```{r fsr_assumptions_multicol_codeblock, eval=FALSE}
...
<span style="color:blue;"> *snippet fsr_influential*</span> [Back to Flowchart](#linear-regression){style="float:right"}
...
```{r fsr_influential_codeblock, eval=FALSE}
...
<span style="color:blue;"> *snippet fsr_outliers*</span> [Back to Flowchart](#linear-regression){style="float:right"}
...
```{r fsr_outliers_codeblock, eval=FALSE}
...
<span style="color:blue;"> *snippet fsr_varselect_linreg*</span> [Back to Flowchart](#linear-regression){style="float:right"}
...
```{r fsr_varselect_linreg_codeblock, eval=FALSE}
...
<span style="color:blue;"> *snippet fsr_modeval*</span> [Back to Flowchart](#linear-regression){style="float:right"}
...
```{r fsr_modeval_codeblock, eval=FALSE}
